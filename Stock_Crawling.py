...
while True:
    ...
    if select == "Stock":
        url = "https://query1.finance.yahoo.com/v7/finance/download/ES=F?period1={}&period2={}&interval=1d&events=history&includeAdjustedClose=true".format(first, second)
        savename = "/Users/dbdudghks/Desktop/stock_S&P.csv"
    elif select == "Oil":
